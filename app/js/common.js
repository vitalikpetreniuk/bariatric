...
// close modal
    ...
    $('body').on('mouseenter', '.map svg .clickable', function(){
        ...
        $('.clinic-plate .text a > div:nth-of-type(1)').html(hovered_state+' information');
        $('.clinic-plate .text a > div:nth-of-type(2) > span:nth-of-type(2)').html(hovered_state+' information');
        $('.clinic-plate .text a > div:nth-of-type(2) > span:nth-of-type(2)').html(hovered_state+' information');
    })
    $('body').on('mouseleave', '.map svg .clickable', function(){
        ...
        $('.clinic-plate').hide();
        last_state = $(this).attr('class').split('clickable ')[1];
    })
    $('body').on('mouseenter', '.clinic-plate', function(){
        $('body').addClass('state-'+last_state);
        $('svg path.'+last_state).attr('hovered');
        $('.clinic-plate').css('display' , 'flex');
    })
    $('body').on('mouseleave', '.clinic-plate', function(){
        $('body').removeClass('state-'+last_state);
        $('svg path.'+last_state).removeAttr('hovered');
        $('.clinic-plate').hide();
    })
